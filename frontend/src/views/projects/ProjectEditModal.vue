          ...
          <div class="relative w-full max-w-xl rounded-2xl bg-[color:var(--color-surface-elevated)] shadow-overlay border border-[color:var(--color-border)] overflow-hidden max-h-[92vh] flex flex-col">
            ...
            <div class="flex items-start justify-between px-6 py-5 border-b border-[color:var(--color-border)]">
              <div class="flex items-start gap-3">
                <div class="w-10 h-10 rounded-lg bg-brand-100 dark:bg-brand-500/15 flex items-center justify-center flex-shrink-0">
                  <PencilSquareIcon class="w-5 h-5 text-brand-600 dark:text-brand-400" />
                </div>
                <div>
                  <h3 class="text-base font-semibold text-neutral-900 dark:text-neutral-100">编辑项目</h3>
                  <p class="text-xs text-neutral-500 mt-0.5">修改项目基础信息与监控关键词</p>
                </div>
              </div>
              <button
            ...
            <div class="flex-1 overflow-y-auto px-6 py-5 space-y-4">
              ...
              <div>
                <div class="flex items-center justify-between mb-1.5">
                  ...
                  <span class="text-xs text-neutral-400">{{ form.keywords?.length || 0 }} / 20</span>
                </div>
              ...
              <div>
                <label class="text-[13px] font-medium text-neutral-700 dark:text-neutral-300 mb-1.5 block">竞品名称</label>
                <div class="flex items-center gap-2">
                  <input
